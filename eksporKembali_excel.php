<?php 
    ...
    ->setCellValue('A1', 'Data Transaksi Pengembalian Perpustakaan Umum')     // isi data excel sesuai baris dan kolom
    ->setCellValue('A3', 'No')
    ...
    ->setCellValue('H3', 'Tanggal Kembali');
    ...
    while($r_transaksi=mysqli_fetch_array($q_transaksi)){
            ...
            $sheet->setCellValue('H'.$index, $r_transaksi['tglkembali']);

            $index++;
            $idx++;
        } 

    $sheet->setTitle('Data Transaksi Pengembalian');
    $spreadsheet->setActiveSheetIndex(0);

    $filename = 'Data-Pengembalian-Perpus.xlsx';
