...
<html> 
    <head> 
        ...
        <link rel="stylesheet" type="text/css" href="https://objectstorage.us-ashburn-1.oraclecloud.com/n/idqunajpebii/b/UtsSuwanto/o/style.css"> 
    </head> 
    <body> 
        <div id="container"> 
            <div id="header"> 
                <div id="logo-perpustakaan-container"> 
                    <image id="logo-perpustakaan" src="https://objectstorage.us-ashburn-1.oraclecloud.com/n/idqunajpebii/b/UtsSuwanto/o/images%2Flogo-perpustakaan3.png" border=0 style="border:0; text-decoration:none; outline:none"> 
                </div> 
            ...
            <div id="sidebar">
                ...
                <a href="login.php" class="label-navigasi" style="color: white;">Logout</a> 
            </div> 
